<template>
  <div>
    <!-- Hero Section -->
    <section
      class="py-24 bg-gradient-to-br from-brand-blue via-brand-blue/80 to-brand-orange/90 text-white border-b border-white/10"
    >
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <p
          class="text-lg md:text-xl text-white/85 font-light max-w-3xl mx-auto"
        >
          {{ hero.subtitle }}
        </p>
      </div>
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid gap-10 md:grid-cols-2 xl:grid-cols-3">
          ...
          >
            ...
            >
              <div
                class="absolute inset-0 bg-gradient-to-br from-brand-blue/30 via-transparent to-brand-orange/40"
              ></div>
            </div>
            <div class="relative flex flex-col items-center flex-1">
              <div class="relative mb-6">
                <div
                  class="absolute inset-0 rounded-full bg-brand-orange/40 blur-3xl opacity-0 group-hover:opacity-60 transition-opacity duration-500"
                ></div>
                <div
                  class="mx-auto h-28 w-28 overflow-hidden rounded-full border-4 border-white/80 shadow-[0_10px_35px_rgba(15,23,42,0.3)]"
                >
                  <img
                    :src="leader.photo"
              ...
              <p
                class="mt-2 text-brand-blue font-medium tracking-[0.3em] uppercase text-[0.65rem]"
              >
                {{ leader.role }}
              </p>
              <p
                class="mt-3 text-sm text-gray-700 leading-relaxed max-h-32 overflow-hidden"
              >
                {{ leader.bio }}
              </p>
            </div>
        ...
        <div class="mt-16">
          ...
          <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div
                class="h-16 w-16 rounded-full bg-brand-blue/5 border border-brand-blue/15 flex items-center justify-center shadow-inner"
              >
                <img
                  :src="member.photo"
              ...
              <div>
                ...
                <p
                  class="text-sm uppercase tracking-[0.25em] text-brand-blue/80"
                >
                  {{ member.role }}
                </p>
              </div>
        ...
        <div class="text-center mt-16">
          <p class="text-gray-600 mb-3 text-sm uppercase tracking-[0.3em]">
            {{ cta.eyebrow }}
          </p>
    ...
    const translations = {
      ...
      kh: {
        hero: {
          ...
          title:
            "ថែរក្សាទីក្រុងភ្នំពេញដោយការអធិស្ឋាន ព្រះវចនៈ និងការគាំទ្រជិតស្និទ្ធ។",
          subtitle:
