<template>
  <div>
    <!-- Hero Section -->
    <section
      class="relative min-h-[55vh] flex items-center overflow-hidden pt-20 md:pt-24 pb-16 bg-gradient-to-br from-[#0a1f33] via-[#162c46] to-[#1e3d5d] text-white"
    >
      <div class="absolute inset-0" aria-hidden="true">
        ...
        ></div>
        <div
          class="absolute inset-y-[-30%] left-[-8%] w-1/2 bg-gradient-to-r from-brand-orange/25 via-transparent to-transparent blur-[150px] opacity-60"
        ></div>
        <div
      ...
      >
        ...
        >
          Prayer nights, serve days, retreats, and gatherings that keep our
          church present in Phnom Penh all year.
        </p>
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div v-else>
          ...
          >
            ...
            >
              <div
                class="relative h-44 bg-gradient-to-br from-brand-blue/90 to-brand-blue flex items-center justify-center"
              >
              ...
              <div class="p-6 flex flex-col gap-4 flex-1">
                ...
                <div class="flex flex-wrap gap-2 text-xs text-gray-600">
                  <span
                    class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-brand-blue/10 text-brand-blue font-medium"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
                    ...
                    >
                      <path
                        ...
                        stroke-width="2"
                        d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a 2 2 0 00-2-2H5a 2 2 0 00-2 2v12a2 2 0 002 2z"
                      />
                    </svg>
                    {{ formatFullDate(event.startTime) }}
                  </span>
                  <span
                    v-if="event.timeRange"
                    class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-brand-orange/10 text-brand-orange font-medium"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
                  ...
                  <span
                    v-if="event.location"
                    class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-gray-100 text-gray-700 font-medium"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
